...
<style>
  ...
  /* Ensure password input has right padding for the icon */
  #loginPassword {
...
<main class="flex-grow pt-28 flex items-center justify-center min-h-screen">
  <!-- added page-auth-container class; styles above will enforce login.html look -->
  <div class="w-full max-w-md mx-auto p-8 bg-[#011538] border border-[#b9da05] text-white rounded-2xl shadow-2xl page-auth-container">
...
// Mobile menu toggle and small helpers may already exist in _header.php; keep page-specific handlers here
