...
switch ($current_page) {
    case 'aboutus.php':
        ...
        break;
    case 'events-and-register-events.html':
        ...
        <div class="flex flex-col h-full">
            ...
            <div class="flex-1 py-4">
                <nav class="space-y-1">
                    ...
                    <!-- Events -->
                    <a href="events-and-register-events.html" class="flex items-center px-4 py-3 text-gray-300 hover:bg-[#16213e] hover:text-white transition-colors duration-200 <?php if($current_page == 'events-and-register-events.html') echo 'bg-[#16213e] text-[#b9da05] border-r-2 border-[#b9da05]'; ?>">
                    ...
                    <?php if ($isLoggedIn): ?>
                        ...
                        <a href="dashboard.html" class="flex items-center px-4 py-3 text-gray-300 hover:bg-[#16213e] hover:text-white transition-colors duration-200 <?php if($current_page == 'announcements.php') echo 'bg-[#16213e] text-[#b9da05] border-r-2 border-[#b9da05]'; ?>">
                            <i class="fas fa-bell w-5 mr-3"></i>
                            <span>Dashboard</span>
                        </a>
                        
                        <!-- Edit Profile -->
                        <a href="edit_profile.html" class="flex items-center px-4 py-3 text-gray-300 hover:bg-[#16213e] hover:text-white transition-colors duration-200">
                            <i class="fas fa-user-edit w-5 mr-3"></i>
                            <span>Edit Profile</span>
                        </a>
                        
                        <!-- Calendar -->
                        <a href="calendar.html" class="flex items-center px-4 py-3 text-gray-300 hover:bg-[#16213e] hover:text-white transition-colors duration-200 <?php if($current_page == 'calendar.html') echo 'bg-[#16213e] text-[#b9da05] border-r-2 border-[#b9da05]'; ?>">
                            <i class="fas fa-calendar-alt w-5 mr-3"></i>
                            <span>Calendar</span>
                        </a>
                        
                        <!-- Settings -->
                        <a href="settings.html" class="flex items-center px-4 py-3 text-gray-300 hover:bg-[#16213e] hover:text-white transition-colors duration-200">
    ...
    <nav id="main-header" class="fixed top-0 left-0 right-0 z-50 py-4">
        <div class="max-w-7xl mx-auto px-4 flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center space-x-6">
                ...
                <!-- Events: Link updated -->
                <a href="events-and-register-events.html" class="nav-link font-semibold <?php if($current_page == 'events-and-register-events.html') echo 'text-[#b9da05]'; ?>">Events</a>
                ...
                <?php if ($isLoggedIn): ?>
                    ...
                    <a href="calendar.html" class="text-white hover:text-[#b9da05] transition-colors duration-300 <?php if($current_page == 'calendar.html') echo 'text-[#b9da05]'; ?>">
                    ...
                    <div class="relative">
                        ...
                        <div id="profile-dropdown" class="absolute right-0 mt-3 w-48 bg-[#00071c] border border-[#b9da05] rounded-lg shadow-xl overflow-hidden hidden transform transition-all duration-300 origin-top-right z-50">
                            <div class="py-1">
                                ...
                                <!-- Dashboard -->
                                <a href="dashboard.html" class="block px-4 py-2 text-sm text-gray-200 hover:bg-[#b9da05] hover:text-[#00071c] transition-colors duration-200 flex items-center space-x-2">
                                    <i class="fas fa-tachometer-alt w-4"></i><span>Dashboard</span>
                                </a>
                                <!-- Edit Profile -->
                                <a href="edit_profile.html" class="block px-4 py-2 text-sm text-gray-200 hover:bg-[#b9da05] hover:text-[#00071c] transition-colors duration-200 flex items-center space-x-2">
                                    <i class="fas fa-edit w-4"></i><span>Edit Profile</span>
                                </a>
                                <!-- Settings -->
                                <a href="settings.html" class="block px-4 py-2 text-sm text-gray-200 hover:bg-[#b9da05] hover:text-[#00071c] transition-colors duration-200 flex items-center space-x-2">
